...
PAGES = [
 ...
 {"slug":"implantes-dentales-tenerife-sur","city":"tenerife-sur","type":"Dentist","img":"foto-clinica.jpg",
  ...
  "desc":"Implantes dentales en Tenerife Sur, también casos complejos: implantes cigomáticos y subperiósticos cuando te han dicho que «no tienes hueso». Cirugía guiada 3D, plan por escrito y financiación.",
  "h1":"¿Te han dicho que <span class=\"accent\">no</span> te pueden poner implantes o que tu caso es complicado?",
  "sub":"En Ocean Clinik Abades valoramos tu caso para devolverte dientes fijos con seguridad, también si te han dicho que no.<br><br>Trabajamos con la última tecnología, cirugía guiada 3D e <strong>implantes cigomáticos y subperiósticos</strong> para casos con poco hueso. Y si hacemos lo difícil, lo sencillo lo hacemos mejor que nadie.",
  ...
  "promesas":["Cirugía guiada 3D","Cigomáticos y subperiósticos","Casos con poco hueso","Presupuesto claro por escrito","Financiación a medida"],
  ...
  "cards_h2":"Por qué elegir Ocean Clinik para tus implantes",
  "cards":[("ic-search","Diagnóstico antes de presupuesto","No proponemos implantes sin estudiar tu caso. Valoramos hueso, encía y mordida con planificación digital 3D.","un diagnóstico de implantes"),
           ...
           ("ic-shield","Cigomáticos y subperiósticos","Cuando falta hueso y te han dicho que no, valoramos técnicas avanzadas para que vuelvas a llevar dientes fijos.","implantes aunque me hayan dicho que no tengo hueso"),
  ...
  "doctor_h2":"Tus implantes, dirigidos por el Dr. Claudio Vázquez",
  ...
  "doctor_checks":["Diagnóstico individual y planificación 3D.","Cirugía guiada por ordenador.","Implantes cigomáticos y subperiósticos.","Casos con poco hueso y rehabilitaciones completas.","Explicación visual del caso.","Plan de tratamiento por escrito.","Opciones de financiación y seguimiento."],
 ...
 {"slug":"implantes-dentales-la-palma","city":"la-palma","type":"Dentist","img":"foto-clinica.jpg",
  ...
  "desc":"Implantes dentales en La Palma, en Santa Cruz de La Palma, también casos complejos: implantes cigomáticos y subperiósticos cuando te han dicho que «no tienes hueso». Cirugía guiada 3D, plan por escrito y financiación.",
  "h1":"¿Te han dicho que <span class=\"accent\">no</span> te pueden poner implantes o que tu caso es complicado?",
  "sub":"En Ocean Clinik La Palma valoramos tu caso para devolverte dientes fijos con seguridad, también si te han dicho que no.<br><br>Trabajamos con la última tecnología, cirugía guiada 3D e <strong>implantes cigomáticos y subperiósticos</strong> para casos con poco hueso. Y si hacemos lo difícil, lo sencillo lo hacemos mejor que nadie.",
  "refuerzo":"Primero estudiamos tu hueso, tu encía y tu mordida. Después te explicamos qué opciones tienes, qué solución recomendamos y qué resultado podemos buscar.",
  "hero_micro":"Te contactamos por WhatsApp o teléfono para buscar el mejor hueco.",
  "wa_label":"Hablar por WhatsApp",
  "cta":"Quiero valorar mi caso de implantes",
  ...
  "intro":["Los <strong>implantes dentales en La Palma</strong> te permiten recuperar la función y la seguridad al sonreír. En Ocean Clinik, en Santa Cruz de La Palma, empezamos por tu diagnóstico, no por el precio, con la última tecnología, planificación 3D y cirugía guiada.",
           ...
           "Trabajamos casos que en otros sitios dan por imposibles. Cuando falta hueso y han descartado un implante convencional, valoramos técnicas avanzadas como los <strong>implantes cigomáticos</strong> (anclados en el pómulo) y los <strong>implantes subperiósticos</strong> (a medida, sobre el hueso). Si te han dicho que «no se puede», pide una segunda opinión antes de resignarte.",
           "Y algo importante: si resolvemos los casos más difíciles, <strong>los casos simples los hacemos aún mejor</strong>. Tanto si te falta una pieza como si necesitas rehabilitar toda la boca, tendrás un plan por escrito y opciones de financiación."],
  "cards_h2":"Por qué elegir Ocean Clinik La Palma para tus implantes",
